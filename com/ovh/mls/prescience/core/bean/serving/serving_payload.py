...
from com.ovh.mls.prescience.core.bean.serving.evaluator import Evaluator, Input
...
class ServingPayload(object):
    ...
    def show_result(self) -> 'ServingPayload':
        ...
        if len(self.get_result_probabilities()) != 0:
            from com.ovh.mls.prescience.core.bean.serving.serving_payload_batch import ServingPayloadBatch
